...
import dataparsers.util.StringUtils.{escape, replacements}
...
object RdfNamespace {
  ...
  val MAPPINGS = ns("mappings", "http://mappings..org/wiki/", false)
