package dataparsers.ontology.datatypes

import dataparsers.DBpediaNamespace
import dataparsers.ontology.OntologyType
import dataparsers.util.{Language, RdfNamespace}
